-- Update cohort pipeline to use month-based naming instead of numbers
  ...
  LOOP
    ...
    BEGIN
      ...
      WHILE upcoming_count < 2 LOOP
        ...
        month_name := TO_CHAR(new_start_date, 'Month');
        ...
        INSERT INTO events (
          ...
          (course_config->course_record.course_slug->>'displayName') || ' - ' || month_name || ' Cohort',
