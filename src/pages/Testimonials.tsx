...
import { Star, TrendingUp, Award, Play, Users, Briefcase, DollarSign } from "lucide-react";
...
const Testimonials = () => {
  ...
  // Video testimonials (would be real YouTube/Vimeo embeds in production)
  const videoTestimonials = [
    {
      id: 1,
      title: "From Warehouse Worker to AML Analyst",
    ...
    {
      id: 3,
      title: "UK Migration Success: From Security to KYC",
        ...
        <div className="container max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {videoTestimonials.map((video) => (
              <Card key={video.id} className="overflow-hidden group border-2 hover:border-tc-amber/50 transition-all hover:shadow-xl">
                <CardContent className="p-0">
                  <div className="relative h-56 overflow-hidden cursor-pointer">
                    ...
                    <div className="absolute inset-0 bg-tc-navy/40 group-hover:bg-tc-navy/30 transition-colors flex items-center justify-center">
                      <div className="w-16 h-16 bg-tc-amber rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                  ...
                  <div className="p-6 space-y-3">
                    <h3 className="font-bold text-lg text-tc-navy leading-tight">
                      {video.title}
                    </h3>
